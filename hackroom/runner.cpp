...
{
    std::string command =
        "g++ -O2 -w -o " + output_path.string() + " " + source_path.string() + " " + flags + " " + "-std=c++23";
...
{
    std::string command = "timeout " + timelimit + " " + program_path + " " + input + " " + output;
...
int main()
{
    const int                num_threads = 20;  // 你可以根据需要调整线程的数量
