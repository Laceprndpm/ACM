...
const std::vector<std::string> process_paths = {"/home/laceprndpm/acm/src/cf/r173/d2/E/E_jiangly.cpp",
                                                "/home/laceprndpm/acm/src/cf/r173/d2/E/E_1.cpp"};
const fs::path                 gene_path     = "/home/laceprndpm/acm/src/cf/r173/d2/E/gene.cpp";
...
int main()
{
    ...
    for (int i = 0; i < num_threads; ++i) {
        threads.emplace_back(helperFunction, i, 100);  // 假设你仍然想要运行1000次
