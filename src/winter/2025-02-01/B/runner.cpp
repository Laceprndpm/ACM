...
const std::vector<std::string> process_paths = {"/home/laceprndpm/acm/src/winter/2025-02-01/B/Bans.cpp",
                                                "/home/laceprndpm/acm/src/winter/2025-02-01/B/B_force.cpp"};
const fs::path                 gene_path     = "/home/laceprndpm/acm/src/winter/2025-02-01/B/gene.cpp";
...
{
    std::string command = program_path + " " + input + " " + output;
    system(command.c_str());
}
...
int main()
{
    ...
    for (int i = 0; i < num_threads; ++i) {
        threads.emplace_back(helperFunction, i, 1000);  // 假设你仍然想要运行1000次
